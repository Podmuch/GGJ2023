...
public class CameraEffects : MonoBehaviour
{
    ...
    protected static Sequence zoomSequence;
    ...
    public static void ZoomOnce(float zoomInFOV, float zoomOutFOV, float duration = 1f, Ease ease = Ease.Flash, Camera camera = null)
    {
        //set data
        var instance = ((camera != null) ? camera : Camera.main);
        ...
        zoomSequence.Append(instance.DOFieldOfView(zoomInFOV, halfDuration).SetEase(ease));
        zoomSequence.Append(instance.DOFieldOfView(zoomOutFOV, halfDuration).SetEase(ease));
    }
