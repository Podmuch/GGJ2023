...
{
    public sealed class CommandQueuePopAfterOpenningQueueSystem : ReactiveSystem<CommandQueueChangeStateEvent>, IInitializeSystem
    {
        [DIInject]
        ...
        public CommandQueuePopAfterOpenningQueueSystem(IEventBus eventBus, IDIContainer diContainer) : base(eventBus)
        {
